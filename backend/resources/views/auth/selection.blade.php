                    ...
                    <div style="border-radius: 15px;" class="col-lg-8 col-md-8 bg-white">
                        <div class="login-fancy pb-40 clearfix">
                            ...
                            <div class="form-inline">
                                <a class="btn btn-default col-lg-3" title="users" href="{{route('login.show','users')}}">
                                ...
                                <a class="btn btn-default col-lg-3" title="paramedics" href="{{route('login.show','paramedics')}}">
                                    <img alt="user-img" width="100px;" src="{{URL::asset('assets/images/logo.png')}}">
                                </a>
                            </div>
